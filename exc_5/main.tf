...
######database######
resource "yandex_compute_instance" "percona1" {
  name = "percona1"
  hostname = "percona1"
...
resource "yandex_compute_instance" "percona2" {
  name = "percona2"
  hostname = "percona2"
...
resource "yandex_compute_instance" "percona3" {
  name = "percona3"
  hostname = "percona3"
...
resource "local_file" "inventory" {
  ...
  content  = <<EOT
[databases]
%{ for vm in yandex_compute_instance.percona1.* ~}
${vm.hostname} ansible_host=${vm.network_interface.0.nat_ip_address} ansible_ssh_common_args='-o StrictHostKeyChecking=no'
%{ endfor }
%{ for vm in yandex_compute_instance.percona2.* ~}
${vm.hostname} ansible_host=${vm.network_interface.0.nat_ip_address} ansible_ssh_common_args='-o StrictHostKeyChecking=no'
%{ endfor }
%{ for vm in yandex_compute_instance.percona3.* ~}
${vm.hostname} ansible_host=${vm.network_interface.0.nat_ip_address} ansible_ssh_common_args='-o StrictHostKeyChecking=no'
%{ endfor }
[backend]
...
${yandex_compute_instance.percona1.network_interface.0.ip_address}	${yandex_compute_instance.percona1.hostname}
${yandex_compute_instance.percona2.network_interface.0.ip_address}	${yandex_compute_instance.percona2.hostname}
${yandex_compute_instance.percona3.network_interface.0.ip_address}	${yandex_compute_instance.percona3.hostname}
